...
if ( empty( $name ) ) {
	$error .= '<li>Your <strong>name </strong>required.</li>';
}

if ( empty( $email ) ) {
	$error .= '<li>Your <strong>e-mail address </strong>required.</li>';
...
if ( empty( $subject ) ) {
	$error .= '<li>Your <strong>subject </strong>required.</li>';
} */

if ( empty( $contactno ) ) {
	$error .= '<li>Your <strong>mobile no </strong>required.</li>';
...
<h3><b>User Submitted Form On Jem Logistics Solutions</b></h3>
...
<table cellpadding='10'>
	...
	$mail->From = "no-reply@jemlogisticssolutions.com";
	$mail->FromName = "Jem Logistics Solutions";
	
	$mail2 = new stdClass();
	$mail2->Host = localhost;
	
	$mail->AddAddress("info@jemlogisticssolutions.com");
	...
	$mail->Subject = 'You got new enquiry from Jem Logistics Solutions Website';
	...
	echo "
		...
		<ul>
			<li><h3><a href='inco-terms.html' target='_blank'>Inco Terms</a></h3></li>
			<li><h3><a href='container-specifications.html' target='_blank'>Container Specifications</a></h3></li>
			<li><h3><a href='industry-links.html' target='_blank'>Industry Links</a></h3>
			</li>
		</ul>
	";
	
	/* header("Location: ../../../premium-content-links.html");
	die(); */
	// Important to have return false in here.
	return false;
